...
local ResourcesManager = CS.ResourcesManager
...
function Init:GlobalInit()            
    ...
    PluginAPI.RegisterAdminPanel("CSM_AP", "csm")
    ...
    PluginAPI.RegisterRoomEvent("CSM")
    ...
    PluginAPI.RegisterRoomEvent("IntercomManager")
    ...
    PluginAPI.RegisterPlayerClass("ChaosInsurgency", true)
    PluginAPI.RegisterPlayerClass("SCP173", true)
...
function Init:InitServer()
    ...
    CS.HookManager.Add("onMapGenerationComplete", function(obj)        
        ...
        PluginAPI.SpawnNetworkedEvent("CSM")   
    ...
    CS.HookManager.Add("onRoundStart", function(obj)
        ...
        PluginAPI.SpawnNetworkedEvent("IntercomManager")  
